            ...
            <div class="col-lg-6 col-md-4 d-none d-lg-block col-12">
                ...
                <div class="header-menu-area text-center">
                    ...
                    <ul class="main-menu">
                            ...
                            <li><a href="">Điện thoại<i class="ion-ios7-arrow-down"></i></a>
                            <ul class="dropdown">
                                            <?php
                             ...
                             <div class="product-tab-menu">
                                <ul class="nav">
                                    ...
                                    <?php
                                                ...
                                                foreach( $load_sp_dm as $spdm ) {
                                                    extract($spdm);
                                                    // echo'<pre>';
                                                    // print_r($spdm);
                                                    $luotxem='<li class="cap2-1"><a href="index.php?act=sp_luotxem&id=' . $iddm . '">lượt xem </a></li>';
                                                    $luotmua ='<li class="cap2-2"><a href="index.php?act=sp_luotmua&id=' . $iddm . '">lượt mua </a></li>';
                                                };
                                            ?>
                                        sắp xếp
                                        <ul class="cap2">
