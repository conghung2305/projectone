                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-4 d-none d-lg-block col-12">
                            ...
                            <div class="header-menu-area text-center">
                                <nav>
                                    <ul class="main-menu">
                                        <li><a href="index.php?act=home">Trang chủ <i
                                                    class="ion-ios7-arrow-down"></i></a>
                                            <!--Dropdown Menu Start-->
                                            <ul class="dropdown">
        ...
        <div class="product-area pt-20 pb-35">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="section-title2">
                            <h2> Sản phẩm theo lượt xem nhiều nhất </h2>
                ...
                $load_sp_dm=loadall_sanpham_iddm($iddm);
                    ...
                    $top_lx = array_slice($load_sp_dm, 0, 6);
                                        ...
                                        <div class="product-content">
                                            <h4><a href="single-product.html">' . $tensp . '</a></h4>
                                                 <div class="product-price">
                                                        <span class="now-price">Lượt xem:' . $luot_xem . '</span>
                                                 </div>
                                                <div class="product-price">
